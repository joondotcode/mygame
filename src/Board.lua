...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            -- create a new tile at X,Y with a random color (8) and variety
...
function Board:findMatches()
    ...
    for x = 1, 8 do 
        for y = 1, 8 do
            ...
            for y2 = y -1, y + 1, 2 do 
                --Make sure they are not at the end of the borders
                ...
                local checkTile = testBoard.tiles[y2][x]

                checkTile = testBoard.tiles[checkTile.gridY][checkTile.gridX]

                tempTile = testBoard.tiles[tile.gridY][tile.gridX]

                testBoard.tiles[tile.gridY][tile.gridX] = checkTile
                testBoard.tiles[checkTile.gridY][checkTile.gridX] = tempTile
            ...
            for x2 = x - 1, x +1, 2 do 
                ...
                local testBoard = Class.clone(self)
                local tile = testBoard.tiles[y][x]
                local checkTile = testBoard.tiles[y][x2]
