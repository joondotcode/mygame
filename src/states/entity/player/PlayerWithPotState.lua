PlayerWithPotState = Class {__includes = EntityWalkState}

function PlayerWithPotState:init(player, dungeon) 
	self.entity = player
...
function PlayerWithPotState:enter (params)
	if params then
		self.pot = params.pot
	end
end

function PlayerWithPotState:update(dt)
    ...
    if love.keyboard.wasPressed('space') then
    	Event.dispatch('throwPot', {pot = self.pot, direction = self.entity.direction})
