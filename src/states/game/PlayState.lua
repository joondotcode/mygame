...
function PlayState:render()
    ...
    if keyConsume then
        ...
        love.graphics.rectangle('fill', VIRTUAL_WIDTH - 16, 0, 16, 16)
        love.graphics.setColor(255, 255, 255, 255)
        love.graphics.draw(gTextures['keys-locks'], gFrames['keys-locks'][1], VIRTUAL_WIDTH - 16, 0)
    end
    ...
    love.graphics.setColor(255, 255, 255, 255)
    love.graphics.print("Level - " .. tostring(self.player.currentLevel), 4, VIRTUAL_HEIGHT - 15)
end
