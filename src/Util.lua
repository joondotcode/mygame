...
function GenerateQuadsBricks(atlas)
    local ModifiedBricks = table.slice(GenerateQuads(atlas, 32, 16), 1, 21)
    table.insert(ModifiedBricks, love.graphics.newQuad(32*5, 16*3, 32, 16, atlas:getDimensions()))
    return ModifiedBricks
end
